					...
					<div class="col-lg-8 col-md-12 col-sm-12">
							...
							<div class="row">
								...
								<div class="col-lg-12">
									<div class="blog-post-thumb big">
										...
										<h3>
											<a href="blog-single.php">Jirono Expands the Leadership Team with David Lin, Controller</a>
										</h3>
										<div class="text">
										...
										<a href="blog-single.php" class="btn-primary-line">Читать</a>
									</div>
								</div>
								<!-- ***** Blog Post Big End ***** -->
								...
								<div class="col-lg-6 col-md-6 col-sm-12">
									<div class="blog-post-thumb">
										...
										<h3>
											<a href="blog-single.php">Jirono Partners with Velocloud to Deliver Managed SD-WAN</a>
										</h3>
										<div class="text">
						...
						<nav>
							<ul class="pagination justify-content-center">
								<li class="page-item">
									<a class="page-link" href="#" aria-label="Предыдущий">
								...
								<li class="page-item">
									<a class="page-link" href="#" aria-label="Следующий">
							...
							<div class="sidebar">
								<div class="search-widget">
									<div class="search">
										<form>
											...
											<button type="submit" aria-label="Искать в статьях"><i class="fa fa-search"></i></button>
										</form>
									</div>
								</div>
								<ul>
								...
								<div class="box">
									...
									<div class="hovered align-self-center">
										<p>Закажите демонстрацию программы просто оставив заявку на сайте</p>
										<a href="contact.php#contact-bottom" class="btn-white-line">Заказать</a>
									</div>
								</div>
							</div>
						</aside>
